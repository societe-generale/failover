 ...
 * {@link com.societegenerale.failover.core.key.KeyGenerator} implementation can
 ...
 * which can be handled by providing a {@link com.societegenerale.failover.core.payload.RecoveredPayloadHandler}.
 *
...
public @interface Failover {
    ...
    /**
     * The expiry unit {@link java.time.temporal.ChronoUnit} for computing the expiry of the entities stored in the failover store.
     * <p>The default value is HOURS
     */
    ChronoUnit expiryUnit() default ChronoUnit.HOURS;

    /**
     * The bean name of the custom {@link com.societegenerale.failover.core.key.KeyGenerator} to use.
     * <p>If not configured, default key generator will be used
     */
    String keyGenerator() default "";

    /**
     * The bean name of the custom {@link com.societegenerale.failover.core.expiry.ExpiryPolicy} to use.
