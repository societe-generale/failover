...
This is a community-maintained open-source project. Response times are best-effort. PRs with tests are the fastest path to getting a fix or feature landed.
