...
| [ADR 46 — PIT Mutation Testing on Expiry and Key Logic](adr.md#adr-46-pit-mutation-testing-on-expiry-and-key-logic) | Profile-gated (`mutation`) PIT on expiry/key packages; baseline recorded, not gated | 15-JUN-2026 | Accepted |
