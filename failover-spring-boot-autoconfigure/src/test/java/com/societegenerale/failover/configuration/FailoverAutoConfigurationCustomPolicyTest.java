 ...
 */
@SpringBootTest(classes = {MyTestApplication.class, FailoverAutoConfigurationCustomPolicyTest.CustomPolicyConfig.class})
@TestPropertySource(properties = {"failover.exception-policy=custom"})
class FailoverAutoConfigurationCustomPolicyTest {
    ...
    void customPolicyBeanOverridesAutoConfiguredDefault() {
        ...
        assertThat(policy).isInstanceOf(CustomPolicyConfig.AlwaysNullPolicy.class);
    }
