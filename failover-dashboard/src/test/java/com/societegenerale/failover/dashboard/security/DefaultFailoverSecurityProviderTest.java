...
class DefaultFailoverSecurityProviderTest {
    ...
    void roleType() {
        ...
        provider.configure(registry, context(new Security(SecurityType.ROLE, "ADMIN", "FAILOVER_ADMIN", null, false, "", false)));
    ...
    void authorityType() {
        ...
        provider.configure(registry, context(new Security(SecurityType.AUTHORITY, "ADMIN", "FAILOVER_ADMIN", null, false, "", false)));
    ...
    void expressionType() {
        ...
        provider.configure(registry, context(new Security(SecurityType.EXPRESSION, "ADMIN", "FAILOVER_ADMIN", expression, false, "", false)));
    ...
    void allowInsecure() {
        ...
        provider.configure(registry, context(new Security(SecurityType.EXPRESSION, "ADMIN", "FAILOVER_ADMIN", "hasRole('ADMIN')", true, "", false)));
    ...
    void blankExpressionRejected() {
        org.assertj.core.api.Assertions.assertThatThrownBy(() ->
                new Security(SecurityType.EXPRESSION, "ADMIN", "FAILOVER_ADMIN", "  ", false, "", false))
