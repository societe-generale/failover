 ...
 *
 * <p>{@link com.societegenerale.failover.store.jdbc.resolver.FailoverStoreQueryResolver} supplies
 * the parameterised SQL statements used by {@code FailoverStoreJdbc}.
 * {@link com.societegenerale.failover.store.jdbc.resolver.PayloadColumnResolver} abstracts the
