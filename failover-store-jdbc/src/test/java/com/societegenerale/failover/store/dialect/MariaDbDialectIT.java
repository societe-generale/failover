...
/**
 * Exercises the {@code INSERT ... ON DUPLICATE KEY UPDATE} merge dialect (shared with MySQL)
 * against a real MariaDB container.
 *
 * @author Anand Manissery
 */
@DisplayName("FailoverStoreJdbc — MariaDB dialect")
class MariaDbDialectIT extends AbstractDialectIT {
