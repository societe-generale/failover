...
- WITH EVERY RESPONSE PROVIDE THE TOKEN USAGES, CURRENT SESSION LIMIT , AND WEEKLY SESSION LIMIT as the last line of each response. [token usage: n, current session limit: x%, weekly session limit: y%]
